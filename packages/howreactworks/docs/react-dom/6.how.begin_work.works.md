...
1. The big `switch-case` in the `beginWork` function.
2. How `createFiberFromElement` creates fibers.

To avoid making this section very huge, they are explained in the next one.
:::
