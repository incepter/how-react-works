...
5. Call the real render function
   ...
   ```
6. Finish rendering and perform logic based on existStatus
...
that was attached during a previous work on the root or any render.
...
todo: add `how errors handling works`.
