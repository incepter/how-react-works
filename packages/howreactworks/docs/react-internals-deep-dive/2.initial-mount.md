...
<!-- <picture><source srcset="/static/fiber-brief-intro-dark.png" media="(prefers-color-scheme: dark)"><img style="cursor:zoom-in" src="/static/fiber-brief-intro-light.png"></picture> -->
...
```
// For hydration, refer to [How basic hydration works internally in React](/react/2023/03/17/how-does-hydration-work-in-react/)
