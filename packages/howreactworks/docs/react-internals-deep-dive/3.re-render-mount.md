...
この仕組みは[初期マウント](/2023-07-14-initial-mount/#313-dom-nodes-are-created-offscreen-in-completework)でも説明されています。
...
function completeWork(
  ...
  switch (workInProgress.tag) {
    ...
    case HostText: {
      ...
      // これは[前回のエピソード](/2023-07-14-initial-mount)で説明した初期マウントブランチです
        ...
        if (wasHydrated) {
